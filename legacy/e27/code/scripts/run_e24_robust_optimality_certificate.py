...
def independent_lexicographic_milp(pair: pd.DataFrame, budget: float) -> tuple[int, float]:
    """Independently maximize cardinality and then minimize edge payment."""
    ...
    costs = feasible["expected_contract_cost"].to_numpy(float)
