...
def solve_a_star(
    ...
    The action domain is [0,1]. The legacy a_min argument is retained
    for callers but is NOT an enforceable action constraint. QoS is
    checked after computing the response, not imposed by the solver.
    """
    a_min = 0.0
